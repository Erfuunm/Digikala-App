...
public class WarehousesController implements Initializable {
    ...
    @FXML
    private Button prevButton, backButton, nextButton , PrintData;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        PrintData.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                alert.setContentText("Data have been saved");
                alert.show();
            }
        });
